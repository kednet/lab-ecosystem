...
from _video_common import PROFILES_DIR  # type: ignore  # noqa: E402
...
def validate_profile(name: str) -> list[str]:
    ...
    for k in ("platform", "tone", "goal", "duration", "voice"):
    ...
    if not cta_profiles:
        errors.append("cta_profiles пустой (должен быть хотя бы 1 тон)")
