# slugify.py — общий модуль Video Creator Skill v1.0
# Скопировано из publisher_skill/scripts/slugify.py 1-в-1 (2026-06-17)
# Используется также в audio_skill/scripts/slugify.py (идентичная копия)
